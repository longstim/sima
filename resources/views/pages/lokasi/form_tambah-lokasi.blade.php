...
@section('page_heading','Tambah Lokasi')
@section('breadcrumb')
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card card-outline card-primary shadow">
			<form role="form" id="tambahlokasi" method="post" action="{{url('lokasi/proses-tambah-lokasi')}}" >
		  	{{ csrf_field() }}

		  	
			<div class="card-body">
				<div class="row col-md-12 mb-2">
					<small><i class="text-muted">Silahkan tambah data Lokasi! (<span class="text-danger">*Wajib diisi</span>)</i></small>
				</div>
				<!-- Card -->
				<div class="card">
