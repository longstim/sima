...
@section('page_heading', 'Daftar Aset')
@section('breadcrumb')
  ...
  <div class="col-md-12">
    ...
    <div class="card card-outline card-primary shadow-lg">
      <div class="card-body">
        ...
        <a href="{{url('aset/tambah-aset')}}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> &nbsp;Tambah Data</a>
        <br><br>
              ...
              <td style="width:85px;">
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu" id="dropdown-action-id">
                    <a class="dropdown-item" href="{{url('aset/detail-aset/'.$data->id)}}">Detail</a>
                    <a class="dropdown-item" href="{{url('aset/qrcode-aset/'.Crypt::encrypt($data->id))}}">QR Code</a>
                    <a class="dropdown-item" href="{{url('aset/ubah-aset/'.Crypt::encrypt($data->id))}}">Edit Data</a>
                    <a class="dropdown-item swalDelete" href="{{url('aset/hapus-aset/'.Crypt::encrypt($data->id))}}">Hapus Data</a>
                 </div>
                </div>
              </td>                        
            </tr>
